...
var cinemaListView = (function(){
	...
	var cinemaListTem = '<ul class="cinema_list">'+
							'<#for(var i=0;i<data.length;i++){ #>'+
								...
								'<li class="cinema_item" onclick="cinemaListView.chooseCinema(\'<#=cinemaInfo.cinema.cid#>\',\'<#=cinemaInfo.cinema.name#>\',\'<#=cinemaInfo.address#>\')" >'+
	...
	function init(options,bathPath){
		...
		link.href = bathPath+"/seat/css/cityandcinema/cityandcinema.css";
...
//	        url:_bathPath+"/info/cinema.do",
	...
	function chooseCinema(cinemaId,cinemaName,cinemaAdd){
		...
		eval(opts.callback).call(this,cinemaId,cinemaName,cinemaAdd,opts.cityId,opts.cityName,cityOpts.locCityId,cityOpts.locCityName);
